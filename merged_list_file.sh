...
0 9,12,20,21 2-15 2 * node /scripts/jd_global_mh.js |ts >> /scripts/logs/jd_global_mh.log 2>&1
...
#必须要的默认定时任务请勿删除
0 2,10,18 * * * docker_entrypoint.sh |ts >> /scripts/logs/default_task.log 2>&1
